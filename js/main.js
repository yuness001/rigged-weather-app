...
const WEATHER_API_KEY = 'e258bcd28e884f469af183725222205';
        ...
        navigator.geolocation.getCurrentPosition(position => {
            ...
            fetch(weatherUrl)
                ...
                .then(data => {
                    ...
                    // render view
                    renderView(temp_c, temp_f, gust_kph, humidity, weatherText, iconPath, name, country);
                })
        })
    } else {
...
const renderView = (temp_c, temp_f, gust_kph, humidity, weatherText, iconPath, name, country) => {
